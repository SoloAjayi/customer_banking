...
def main():
    ...
    print("Updated savings account balance with interest earned: ", updated_savings_balance)
    ...
    # ADD YOUR CODE HERE
    print("\nInterest earned on CD account: ", interest_earned)
    print("Updated CD account balance with interest earned: ", updated_cd_balance)
